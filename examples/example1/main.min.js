var app = (function (exports, possibleConstructorReturn, inherits, regenerator, slicedToArray, asyncToGenerator, classCallCheck, createClass, _typeof, buffer, fs, http, https, url, toConsumableArray, toArray$1) {
  'use strict';

  possibleConstructorReturn = possibleConstructorReturn && possibleConstructorReturn.hasOwnProperty('default') ? possibleConstructorReturn['default'] : possibleConstructorReturn;
  inherits = inherits && inherits.hasOwnProperty('default') ? inherits['default'] : inherits;
  regenerator = regenerator && regenerator.hasOwnProperty('default') ? regenerator['default'] : regenerator;
  slicedToArray = slicedToArray && slicedToArray.hasOwnProperty('default') ? slicedToArray['default'] : slicedToArray;
  asyncToGenerator = asyncToGenerator && asyncToGenerator.hasOwnProperty('default') ? asyncToGenerator['default'] : asyncToGenerator;
  classCallCheck = classCallCheck && classCallCheck.hasOwnProperty('default') ? classCallCheck['default'] : classCallCheck;
  ...
  toConsumableArray = toConsumableArray && toConsumableArray.hasOwnProperty('default') ? toConsumableArray['default'] : toConsumableArray;
  toArray$1 = toArray$1 && toArray$1.hasOwnProperty('default') ? toArray$1['default'] : toArray$1;
  ...
  var scheme = new Array(3).concat("edf8b17fcdbb2c7fb8", "ffffcca1dab441b6c4225ea8", "ffffcca1dab441b6c42c7fb8253494", "ffffccc7e9b47fcdbb41b6c42c7fb8253494", "ffffccc7e9b47fcdbb41b6c41d91c0225ea80c2c84", "ffffd9edf8b1c7e9b47fcdbb41b6c41d91c0225ea80c2c84", "ffffd9edf8b1c7e9b47fcdbb41b6c41d91c0225ea8253494081d58").map(colors);
  ...
  */
    ...
    var GeoTIFFImage = function () {
      ...
      (0, _createClass3.default)(GeoTIFFImage, [{
        ...
        value: function () {
          ...
          /*#__PURE__*/
          _regenerator2.default.mark(function _callee(x, y, sample, poolOrDecoder) {
            ...
            return _regenerator2.default.wrap(function _callee$(_context) {
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 10:
                    slice = _context.sent; // either use the provided pool or decoder to decode the data
        ...
        value: function () {
          ...
          /*#__PURE__*/
          _regenerator2.default.mark(function _callee2(imageWindow, samples, valueArrays, interleave, poolOrDecoder, width, height, resampleMethod) {
            var _this = this;
  ...
  var source = createCommonjsModule(function (module, exports) {
    ...
    var wait = function () {
      var _ref = (0, _asyncToGenerator3.default)(
      /*#__PURE__*/
      _regenerator2.default.mark(function _callee(milliseconds) {
        return _regenerator2.default.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
    ...
    var BlockedSource = function () {
      ...
      (0, _createClass3.default)(BlockedSource, [{
        ...
        value: function () {
          var _ref3 = (0, _asyncToGenerator3.default)(
          /*#__PURE__*/
          _regenerator2.default.mark(function _callee3(offset, length) {
            var _this = this;
            ...
            return _regenerator2.default.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
                  case 0:
                    top = offset + length; // calculate what blocks intersect the specified range (offset + length)
                  ...
                  case 10:
                    ...
                    groups = getCoherentBlockGroups(Array.from(this.blockIdsAwaitingRequest).sort()); // iterate over all blocks

                    _loop = function _loop(group) {
                      // fetch a group as in a single request
                      var request = _this.requestData(group[0] * _this.blockSize, group.length * _this.blockSize); // for each block in the request, make a small 'splitter',
                      ...
                      var _loop2 = function _loop2(_i) {
                        ...
                        _this.blockRequests.set(id, (0, _asyncToGenerator3.default)(
                        /*#__PURE__*/
        ...
        value: function () {
          var _ref5 = (0, _asyncToGenerator3.default)(
          /*#__PURE__*/
          _regenerator2.default.mark(function _callee4(requestedOffset, requestedLength) {
            var response;
            return _regenerator2.default.wrap(function _callee4$(_context4) {
              while (1) {
                switch (_context4.prev = _context4.next) {
    ...
    function makeFetchSource(url) {
      ...
      return new BlockedSource(function () {
        ...
        /*#__PURE__*/
        _regenerator2.default.mark(function _callee5(offset, length) {
    ...
    function makeXHRSource(url) {
      ...
      return new BlockedSource(function () {
        ...
        /*#__PURE__*/
        _regenerator2.default.mark(function _callee6(offset, length) {
    ...
    function makeHttpSource(url) {
      ...
      return new BlockedSource(function () {
        ...
        /*#__PURE__*/
        _regenerator2.default.mark(function _callee7(offset, length) {
    ...
    function makeBufferSource(arrayBuffer) {
      return {
        fetch: function () {
          ...
          /*#__PURE__*/
          _regenerator2.default.mark(function _callee8(offset, length) {
    ...
    function makeFileSource(path) {
      ...
      return {
        fetch: function () {
          ...
          /*#__PURE__*/
          _regenerator2.default.mark(function _callee9(offset, length) {
    ...
    function makeFileReaderSource(file) {
      return {
        fetch: function () {
          ...
          /*#__PURE__*/
          _regenerator2.default.mark(function _callee10(offset, length) {
    ...
    var Pool = function () {
      ...
      (0, _createClass3.default)(Pool, [{
        ...
        value: function () {
          var _ref = (0, _asyncToGenerator3.default)(
          /*#__PURE__*/
          _regenerator2.default.mark(function _callee(fileDirectory, buffer) {
            var _this = this;
        ...
        value: function () {
          var _ref3 = (0, _asyncToGenerator3.default)(
          /*#__PURE__*/
          _regenerator2.default.mark(function _callee3(currentWorker) {
            var waiter;
            return _regenerator2.default.wrap(function _callee3$(_context3) {
              while (1) {
                switch (_context3.prev = _context3.next) {
  ...
  */
  ...
  var typeName2byte = (0, utils.invert)(globals.fieldTypeNames); // config variables
  ...
  var geotiff = createCommonjsModule(function (module, exports) {
    ...
    var fromUrl = exports.fromUrl = function () {
      ...
      /*#__PURE__*/
      _regenerator2.default.mark(function _callee10(url) {
    ...
    var fromArrayBuffer = exports.fromArrayBuffer = function () {
      ...
      /*#__PURE__*/
      _regenerator2.default.mark(function _callee11(arrayBuffer) {
    ...
    var fromFile = exports.fromFile = function () {
      ...
      /*#__PURE__*/
      _regenerator2.default.mark(function _callee12(path) {
    ...
    var fromBlob = exports.fromBlob = function () {
      var _ref13 = (0, _asyncToGenerator3.default)(
      /*#__PURE__*/
      _regenerator2.default.mark(function _callee13(blob) {
    ...
    var fromUrls = exports.fromUrls = function () {
      var _ref14 = (0, _asyncToGenerator3.default)(
      /*#__PURE__*/
      _regenerator2.default.mark(function _callee14(mainUrl) {
    ...
    var writeArrayBuffer = exports.writeArrayBuffer = function () {
      var _ref15 = (0, _asyncToGenerator3.default)(
      /*#__PURE__*/
      _regenerator2.default.mark(function _callee15(values, metadata) {
    ...
    var GeoTIFF = function (_GeoTIFFBase) {
      ...
      (0, _createClass3.default)(GeoTIFF, [{
        ...
        value: function () {
          var _ref2 = (0, _asyncToGenerator3.default)(
          /*#__PURE__*/
          _regenerator2.default.mark(function _callee2(offset, size) {
            var fallbackSize;
            return _regenerator2.default.wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
              ...
              while (1) {
                switch (_context3.prev = _context3.next) {
                  ...
                  case 7:
                    ...
                    numDirEntries = this.bigTiff ? dataSlice.readUint64(nextIFDByteOffset) : dataSlice.readUint16(nextIFDByteOffset); // if the slice does not cover the whole IFD, request a bigger slice, where the
                  ...
                  case 44:
                    fileDirectories.push([fileDirectory, parseGeoKeyDirectory(fileDirectory)]); // continue with the next IFD
        ...
        value: function () {
          ...
          /*#__PURE__*/
          _regenerator2.default.mark(function _callee6(source, options) {
...
}({}, _possibleConstructorReturn3, _inherits3, _regenerator2, _slicedToArray3, _asyncToGenerator3, _classCallCheck3, _createClass3, _typeof3, buffer, fs, _http2, _https2, _url2, _toConsumableArray3, _toArray3));
